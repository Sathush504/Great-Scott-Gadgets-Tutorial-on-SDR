...
class lesson1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "lesson1")
        ...
        self._channel_freq2_range = qtgui.Range(87.9e6, 107.9e6 , 100, 98.5e6, 200)
        self._channel_freq2_win = qtgui.RangeWidget(self._channel_freq2_range, self.set_channel_freq2, "'channel_freq2'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._channel_freq2_win)
        self._channel_freq1_range = qtgui.Range(87.9e6, 107.9e6 , 100, 96.5e6, 200)
        self._channel_freq1_win = qtgui.RangeWidget(self._channel_freq1_range, self.set_channel_freq1, "'channel_freq1'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._channel_freq1_win)
        self._audio_gain2_range = qtgui.Range(0, 10, 1, 0, 200)
        self._audio_gain2_win = qtgui.RangeWidget(self._audio_gain2_range, self.set_audio_gain2, "'audio_gain2'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._audio_gain2_win)
        self._audio_gain1_range = qtgui.Range(0, 10, 1, 1, 200)
        self._audio_gain1_win = qtgui.RangeWidget(self._audio_gain1_range, self.set_audio_gain1, "'audio_gain1'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._audio_gain1_win)
